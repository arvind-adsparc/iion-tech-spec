...
- [Tech Stack:](#tech-stack)
  ...
  - [AntDesign](#antdesign)
  - [MongoDB](#mongodb)
    - [Benefits of NoSQL database:](#benefits-of-nosql-database)
- [High SEO & performance score for mobile and web:](#high-seo---performance-score-for-mobile-and-web-)
...
- [Site Management and Monitoring Service:](#site-management-and-monitoring-service-)
  - [Amazon CloudWatch [paid]
    - [Features:](#features)
  - Uptime Robot [free + paid] (#uptime-robot--free---paid)
    - [Features:](#features--1)
  - [Pingdom [paid] - [Link](https://www.pingdom.com/)](#pingdom--paid-----link--https---wwwpingdomcom--)
    - [Features:](#features--2)
- [Unit Testing:](#unit-testing-)
- [Automated Testing(Visual):](#automated-testing-visual--)
  - [BrowserStack - [Link](https://www.browserstack.com/)](#browserstack----link--https---wwwbrowserstackcom--)
...
- [Heatmap Tool:](#heatmap-tool-)
  - [Must have features:](#must-have-features-)
- [A/B Testing:](#a-b-testing-)
  - [Process:](#process-)
  - [Top A/B testing tool:](#top-a-b-testing-tool-)
    - [[Google Optimize](https://marketingplatform.google.com/about/optimize/)](#-google-optimize--https---marketingplatformgooglecom-about-optimize--)
    - [[Optimizely](https://www.optimizely.com/)](#-optimizely--https---wwwoptimizelycom--)
    - [[Zoho PageSense](https://www.zoho.com/pagesense/)](#-zoho-pagesense--https---wwwzohocom-pagesense--)
    - [[HubSpot](https://www.ventureharbour.com/recommends/hubspot/)](#-hubspot--https---wwwventureharbourcom-recommends-hubspot--)
    - [[Omniconvert](https://www.omniconvert.com/)](#-omniconvert--https---wwwomniconvertcom--)
